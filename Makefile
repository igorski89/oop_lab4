#############################################################################
# Makefile for building: oop_lab4
# Generated by qmake (2.01a) (Qt 4.5.0) on: ?? ???. 24 00:05:32 2009
# Project:  oop_lab4.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/local/Qt4.5/mkspecs/macx-g++ -macx CONFIG+=debug_and_release -o Makefile oop_lab4.pro
#############################################################################
...
Makefile: oop_lab4.pro  /usr/local/Qt4.5/mkspecs/macx-g++/qmake.conf /usr/local/Qt4.5/mkspecs/common/unix.conf \
	...
	$(QMAKE) -spec /usr/local/Qt4.5/mkspecs/macx-g++ -macx CONFIG+=debug_and_release -o Makefile oop_lab4.pro
